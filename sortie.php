...
<div class="py-4">
    ...
    <div class="p-5 mb-4 bg-light rounded-3 cont1">
        ...
        <h1 class="display-5 fw-bold">Sortie de caisse de l'eglise</h1>
    ...
    <!-- ----------------------------FORMMULAIRE DE CREDIT------------------------ -->
      <div class="col-md-6">
        <div class="h-100 p-5 text-white bg-dark rounded-3">
            <h2>Ajouter une sortie : </h2><br>

            <form action="sortie.php" method="post" class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
            ...
            if(isset($_POST['enregistrer'])){
                ...
                $requette_affiche_eglise = "SELECT * FROM eglise";
                $resultat_affiche_eglise = $conn->query($requette_affiche_eglise);
                $data_eglise = $resultat_affiche_eglise->fetch(PDO::FETCH_ASSOC);
                $solde_eglise = $data_eglise['solde'];
                ...
                if(!empty($motif) && !empty($montant) && !empty($date)){
                    $seuil = $solde_eglise - $montant;
                    
                    if($seuil < 10000){?>
                            <script type = "text/javascript"> alert("le solde de l'eglise est insufisant, il ne doit pas être inférieur a 10000Ar") </script>
                            <?php
                        }
                        else{
                        $requete = $conn->prepare('INSERT INTO sortie(motif, montant, dateSortie) VALUES(:motif, :montant, :date)');
            ...
            ?>
            <br>
            <h2>Suprimer dans sortie </h2><br>
            <form action="delete/suprimer_dans_sortie.php" method="post" class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
      ...
      <div class="col-md-6">
        <div class="h-100 p-5 bg-light border rounded-3">
            ...
            <div class="titre_recherche">
                <h2>Table sortie</h2>
                <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3 form1" action="sortie.php" method="post">
            ...
            <?php
                ...
                if(!empty($_POST['recherche'])){
                    $recherche = $_POST['recherche'];
                    $requete_recherche = "SELECT * FROM sortie WHERE motif LIKE '%$recherche%'";
            ...
            <?php
                    ...
                    //AFFICHER LE TABLE SORTIE
                    $requette_affiche_entre = "SELECT * FROM sortie";
                ...
                <tbody>
                    <?php
                        while($ligne = $resultat_affiche_entre->fetch(PDO::FETCH_ASSOC)){
                            ?>
                            <tr>
                                <td><?php echo $ligne['idSortie']?></td>
                                <td><?php echo $ligne['motif']?></td>
                                <td><?php echo $ligne['montant']?></td>
                                <td><?php echo $ligne['dateSortie']?></td>
                                <td><a href="update/update_sortie.php?id=<?php echo $ligne['idSortie'] ?>" class="link-dark"><i class="bi bi-pencil-square"></i></a></td>
            ...
            ?>
            <br>
            <?php echo "<img src = 'histogramme/histogramme_sortie.php'";?>
